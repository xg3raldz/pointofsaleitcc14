...
#check{
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="../delivery/delivery.php"><i class="fas fa-hands-helping"></i><span>Transaction Details</span></a>
      <a href="../delivery/add_delivery.php"><i class="fas fa-truck"></i><span>Add Deliveries</span></a>
      <a href="../delivery/import_csv.php"><i class="fas fa-file-upload"></i><span>Import CSV</span></a>
...
<div class="header bg-dark">
	<img class="img-fluid w-100 mt-2 ml-1" src="" >
</div>
<div class="sidebar">
