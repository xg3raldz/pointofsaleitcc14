...
#check{
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="../products/products.php"><i class="fas fa-user-alt"></i><span>Product List</span></a>
      <a href="../delivery/add_delivery.php"><i class="fas fa-users-cog"></i><span>Add Product</span></a>
