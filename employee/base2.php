...
#check{
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="../employee/inventory.php"><i class="fas fa-list-ul"></i><span>Product List</span></a>
     
     

      <a href="../employee_page.php"><i class="fas fa-arrow-circle-left"></i><span>Back</span></a>
    </div>
    <!--sidebar end-->
