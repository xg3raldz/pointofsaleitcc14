<?php include('../server/connection.php');
	...
	if(isset($_POST['add'])){
		...
		if (count($error) == 0){
			...
			$sql  = "INSERT INTO user (username,firstname,lastname,position,contact_number,password,image) VALUES ('$username','$firstname','$lastname','$position','$number','$password','$image')";
