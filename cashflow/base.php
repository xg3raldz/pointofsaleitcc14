...
#check{
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="../cashflow/cashflow.php"><i class="fas fa-list-ul"></i><span>List</span></a>
      <a href="../cashflow/add_cash.php"><i class="fas fa-money-bill-alt"></i><span>Add Cash-in/Cash-out</span></a>
